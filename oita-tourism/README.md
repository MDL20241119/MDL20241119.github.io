...
Neo Swiss。紙白 #F8F7F3 と黒 #111111 の罫線・モジュラーグリッド、数字を主役とするグロテスク書体を使用。地域・課題は #E7FF38、アクセス・検索は #72D7FF、比較・使い方は #FF4FC3 を主色とし、画面ごとに１つのアクセントで分類します。デスクトップの16:9と小型画面の縦並びを想定し、影・丸いカード・装飾写真を使いません。
