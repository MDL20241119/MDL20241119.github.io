export const integrationStatus=[
 ...
 {name:'COMmmmONS デマンドバス',version:'1.0.0',implementation:'10操作を実装・9操作未実装',verification:'採用した入出力の原本契約試験済み',connection:'交通事業者未接続',scope:'サービス・停留所・条件・候補・本人予約・取消・無料支払状態。合成の2点間・配車済み便に限定'},
