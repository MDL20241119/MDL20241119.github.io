...
(function(){
  ...
  window.YokoAdmin={create({getState,showRecord}){
    let active=false,filter={kind:'all'},selectedId=null;
    ...
    function leave(){active=false;filter={kind:'all'};selectedId=null;document.body.classList.remove('admin-ui');$('admin-panel').hidden=true;}
