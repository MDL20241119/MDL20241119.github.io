...
(() => {
  ...
  async function main(){
    ...
    await new Promise((resolve,reject)=>{const script=document.createElement('script');script.src='./app.js?v=16b';script.onload=resolve;script.onerror=()=>reject(new Error('画面を読み込めませんでした'));document.head.append(script);});
