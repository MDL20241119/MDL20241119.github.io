...
最新のデザイン指定は **Bold Neo-Brutalist Editorial**（2026年9月26日）。オレンジ #FF8A00 を軸に、ブルー・イエロー・ピンク・ライム・ラベンダーを章ごとに配色。黒い細線、非対称の写真グリッド、極太の英字と日本語見出し、番号とメタ情報を使用します。風景とGarraway0の実写を17か所に配置。写真の色・内容は変更せず、表示枠でトリミング。影・グラデーションは使用しません。前回のGinger風デザインからトップの見た目を更新しました。
