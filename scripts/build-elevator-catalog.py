...
rect(M,251,523,46,LIME); para('大分実証：トヨタカローラ大分の試乗車（アルファード）を活用し、<br/>地元住民を送迎しました。',M+14,257,496,11.5,bold=True,leading=17)
...
rect(M,365,362,74,LIME);para('大分実証：トヨタカローラ大分の<br/>試乗車（アルファード）を活用し、<br/>地元住民を送迎しました。',M+15,374,332,12.5,bold=True,leading=18)
